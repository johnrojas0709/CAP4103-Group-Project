...
def main():
    ...
    X_raw, y = load_images_from_directory(dataset_train)
    if len(X_raw) == 0:
        print("No images loaded.")
        return

    # Split dataset into 90% training and 10% testing
    X_train_raw, X_test_raw, y_train, y_test = train_test_split(X_raw, y, test_size=0.1, random_state=42, stratify=y)
